...
$(function() {
    var config = {
      apiKey: "AIzaSyBT45EZ055wCnz1EuJ7XLEtL5WFtxhzPZE",
      authDomain: "portfolio-baf3b.firebaseapp.com",
      projectId: "portfolio-baf3b",
      storageBucket: "portfolio-baf3b.appspot.com",
      messagingSenderId: "1072789507207",
      appId: "1:1072789507207:web:db9f0793aad68441fcfc22",
      databaseURL: "https://portfolio-baf3b-default-rtdb.firebaseio.com/",
    };
    ...
    projectRef.once("value").then(function(snap) {
      ...
      function aboutClick() {
        ...
        var aboutText =
          "I'm a Mechatronics engineering student with interest for rockets, battlebots, drones, AI, machine learning in general as well as App development, Web development and basically telling the computer what to do (coding).";
        var skillList =
          "Python / Dart / Swift / C# / C++ / JS / HTML / CSS / Svelte / Flutter / Tensorflow / Pytorch / Flask / Nginx / Docker <br><br> Experience with Debian based Linux distros like Ubuntu and Ubuntu Server";
        var skillList2 =
        ...
        var bio2 = $(
          '<h3 class="logo folded about"><div class="line solid"><p class="yeehover" style="margin-top:-0.8em">&nbsp</p><p>' +
            ...
            aboutText +
            '<br><br><br><a class="external" href="mailto:a.a.r.samuel99@gmail.com" target="blank">Contact Me</a><br>' +

            "<br><br><br><b>Software</b><br><br>" +
            skillList2 +
            "<br><br><br><b>Programming languages and Frameworks</b><br><br>" +
            skillList +
            "</div></div>"
        );
